...
const watchlist_item_schema = new Schema<WatchlistItemDoc>({
...
export const WatchlistItem = mongoose.model<WatchlistItemDoc>("WatchlistItem", watchlist_item_schema);

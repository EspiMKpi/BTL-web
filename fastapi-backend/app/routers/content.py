...
GET /home, GET /genres, GET /browse/:genre_id, GET /movie/:id, GET /series/:id
"""
...
@router.get("/home")
async def home(current_user: Optional[dict] = Depends(get_optional_current_user)):
    user_id = current_user["_id"] if current_user else None
    return await get_home_rails(user_id)
